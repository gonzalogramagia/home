...
export default function ShortcutFloater() {
    ...
    const handleUrlChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Only auto-fill if iconUrl is empty
        if (!iconUrl) {
            try {
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 items-center">
                                    {iconUrl && (
                                        <div className="w-10 h-10 relative flex-shrink-0 rounded-md overflow-hidden bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700">
                                            <img
                                                src={iconUrl}
                                                alt="Preview"
